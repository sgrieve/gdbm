...
number=$SGE_TASK_ID
paramfile=/data/home/faw513/gdbm/processing/array_params_15_99l.txt
...
# Run the application.
sh /data/home/faw513/gdbm/processing/runner_l.sh $variable1 $variable2 $variable3 $variable4 $variable5 $variable6
