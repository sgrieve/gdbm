...
cd /data/Geog-c2s2/gdbm-sensi-l/
mkdir $1
cd $1
...
/data/home/faw513/LSDTopoTools_ChiMudd2014/driver_functions_MuddChi2014/gdbm_analysis.exe /data/Geog-c2s2/gdbm-sensi-l/$1/ $1 /data/Geog-c2s2/gdbm-sensi-l/$1/ $1 $4 $5 $6
